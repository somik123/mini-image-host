    ...
    if ($_POST['textblk']) {
        ...
        if ($file_host == 1) {
            ...
            if ($file_host == 101) {
                ...
                $url = "https://imgbb.com/";
                $name = "ImgBB";
            } elseif ($file_host == 102) {
                // FreeImage.host
                $url = "https://freeimage.host/";
                $name = "FreeImage.host";
            } else if ($file_host == 103) {
                // HostImage.org
                $url = "https://hostimage.org/";
                $name = "HostImage.org";
            } elseif ($file_host == 104) {
                // PasteImg
                $url = "https://pasteimg.com/";
                $name = "PasteImg";
            } elseif ($file_host == 105) {
                // Imgbb.ws
                $url = "https://imgbb.ws/";
                $name = "ImgBB.ws";
            } elseif ($file_host == 106) {
                // img.in.th
                $url = "https://www.img.in.th/";
                $name = "img.in.th";
            } elseif ($file_host == 107) {
                // Dodaj.rs
                $url = "https://dodaj.rs/";
                $name = "Dodaj.rs";
            } elseif ($file_host == 108) {
                // Inspirats
                $url = "https://inspirats.com/";
                $name = "Inspirats";
            } elseif ($file_host == 109) {
                // FxPics.ru
                $url = "https://fxpics.ru/";
                $name = "FxPics.ru";
            } elseif ($file_host == 110) {
                // Poop.pictures
                $url = "https://poop.pictures/";
                $name = "Poop.pictures";
            } elseif ($file_host == 111) {
                // Site.pictures
                $url = "https://site.pictures/";
                $name = "Site.pictures";
            } elseif ($file_host == 112) {
                // SnappyPic
                $url = "https://snappypic.com/";
                $name = "SnappyPic";
            } elseif ($file_host == 113) {
                // Eikona.info
